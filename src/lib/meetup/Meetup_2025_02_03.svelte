...
<Slide id="list" animate>
	...
	<ul>
		...
		<span class="speaker">
			...
			/>
			<div class="talk-info">
				<div>Hey Svelte! Extend my CMS</div>
		...
		<span class="speaker">
			...
			/>
			<div class="talk-info">
				<div>Svelte in enterprise-scale projects: learnings and best-practices</div>
		...
		<span class="speaker">
			<img
				src={'https://avatars.githubusercontent.com/u/26281609?v=4'}
				alt="Paolo Ricciuti"
				class="avatar"
			/>
			<div class="talk-info">
				<div>Herd your async tasks!</div>
				<div class="speaker-name">Paolo Ricciuti</div>
			</div>
		</span>
	</ul>
</Slide>
